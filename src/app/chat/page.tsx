...
export default function ChatPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream-50 to-green-50 dark:from-gray-900 dark:to-gray-800 py-3 sm:py-6 px-2 sm:px-4">
      <Toaster position="top-right" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className={`${selectedConversation ? 'hidden md:flex' : 'flex'} mb-3 sm:mb-6 items-center justify-between`}>
          <div className="flex items-center space-x-2 sm:space-x-4">
            <button
              ...
              className="p-1.5 sm:p-2 hover:bg-white dark:hover:bg-gray-800 rounded-lg transition-colors"
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg sm:shadow-2xl overflow-hidden" style={{ height: 'calc(100vh - 140px)' }}>
          <div className="flex h-full">
            ...
            <div className={`${selectedConversation ? 'hidden md:flex' : 'flex'} w-full md:w-2/5 lg:w-1/3 border-r border-gray-200 dark:border-gray-700 flex-col bg-gray-50 dark:bg-gray-900`}>
              ...
              <div className="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                <h2 className="text-base sm:text-lg font-bold text-gray-900 dark:text-gray-100 text-left">Messages</h2>
              </div>
              ...
              <div className="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                <div className="relative">
                  <input
                    ...
                    placeholder="Search..."
                    className="w-full pl-8 sm:pl-10 pr-3 sm:pr-4 py-1.5 sm:py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-green bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-xs sm:text-sm"
                  />
                  ...
                  {filteredConversations.map((conversation) => {
                    ...
                    return (
                      <div
                        ...
                        className={`p-2.5 sm:p-3 border-b border-gray-100 dark:border-gray-700 cursor-pointer transition-all hover:bg-gray-100 dark:hover:bg-gray-700 active:bg-gray-200 dark:active:bg-gray-600 ${
                      ...
                      >
                        <div className="flex items-center gap-2 sm:gap-3 w-full">
                          <div className="relative flex-shrink-0">
                            ...
                            />
                            <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 sm:w-3.5 sm:h-3.5 bg-green-500 border-2 border-white dark:border-gray-900 rounded-full"></div>
                          </div>
                          <div className="flex-1 min-w-0">
                            <div className="flex items-baseline justify-between gap-1.5 sm:gap-2 mb-0.5 sm:mb-1">
                              <h4 className="text-xs sm:text-sm font-bold text-gray-900 dark:text-gray-100 truncate text-left">
                                {displayName}
                              </h4>
                            ...
                            <p className="text-[10px] sm:text-xs text-gray-600 dark:text-gray-400 truncate text-left mb-0.5">
                              {conversation.product.name}
                            </p>
                            {lastMessage && (
                              <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 truncate text-left">
                                {lastMessage.content}
                              </p>
                            )}
                          </div>
            ...
            <div className={`${!selectedConversation ? 'hidden md:flex' : 'flex'} flex-1 flex-col`}>
              {selectedConversation ? (
                <>
                  ...
                  <div className="p-2.5 sm:p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                    <div className="flex items-center justify-between">
                      {/* Back button for mobile */}
                      <button
                        onClick={() => setSelectedConversation(null)}
                        className="md:hidden mr-2 p-1.5 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg"
                      >
                        <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-600 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                        </svg>
                  ...
                  <div className="flex-1 overflow-y-auto p-3 sm:p-4 lg:p-6 space-y-2 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800"
                       style={{
                              ...
                              <div className={`flex items-center gap-1.5 sm:gap-2 mt-1 px-1 ${isRightSide ? 'flex-row-reverse' : 'flex-row'}`}>
                                ...
                                {isOwn && !message.id.startsWith('temp-') && (
                                  <button
                                    ...
                                    className="opacity-0 group-hover:opacity-100 transition-opacity text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 p-0.5 sm:p-1 hover:bg-red-50 dark:hover:bg-red-900/20 rounded"
                  ...
                  <div className="p-2 sm:p-3 lg:p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 relative">
                    ...
                    <div className="flex items-end space-x-1.5 sm:space-x-2">
                      ...
                      <button
                        ...
                        className="hidden sm:block p-1.5 sm:p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
                        title="Attach file"
                      >
                        <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-600 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <textarea
                        ...
                        rows={1}
                        className="flex-1 px-3 py-2 sm:px-4 sm:py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-green resize-none bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-xs sm:text-sm"
                    ...
                    <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 mt-1.5 sm:mt-2 hidden sm:block">
