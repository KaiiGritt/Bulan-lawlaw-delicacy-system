...
export default function VerifyEmailPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cream-50 to-green-50 dark:from-gray-900 dark:to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
          ...
          {verified ? (
            ...
            <>
              ...
              <div className="space-y-3">
                ...
                <Link
                  href="/login"
                  className="w-full bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white py-3 px-4 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors inline-block"
                >
                  Back to Login
                </Link>
              </div>
