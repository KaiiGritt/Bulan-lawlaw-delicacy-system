            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1">
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700 sticky top-24 animate-pulse">
                  <div className="h-6 bg-gray-200 dark:bg-gray-700 rounded w-36 mb-6"></div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-cream-50 to-green-50 dark:bg-gray-950 py-12 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl mx-auto text-center py-16">
            <div className="text-6xl mb-6">🎉</div>
            <h1 className="text-4xl font-bold text-primary-green dark:text-green-400 mb-4">Order Placed Successfully!</h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              Thank you for your order. We&apos;ll send you a confirmation email shortly.
            </p>
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-8 border border-gray-100 dark:border-gray-700">
              <h2 className="text-2xl font-bold text-primary-green dark:text-green-400 mb-4">Order Summary</h2>
              <div className="text-left space-y-2 text-gray-900 dark:text-gray-100">
    ...
    <div className="min-h-screen bg-gradient-to-br from-cream-50 to-green-50 dark:bg-gray-950 py-12 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="mb-8 fade-in-up">
          <h1 className="text-4xl font-bold text-primary-green dark:text-green-400 mb-2">Checkout</h1>
          <p className="text-gray-600 dark:text-gray-300">Complete your order for Lawlaw delicacies</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700 fade-in-up">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-primary-green dark:text-green-400 flex items-center gap-2">
              ...
              {selectedAddress ? (
                <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <h3 className="font-semibold text-lg dark:text-white">{selectedAddress.fullName}</h3>
                      <p className="text-gray-600 dark:text-gray-400 text-sm">{selectedAddress.phoneNumber}</p>
                    </div>
                ...
                <div className="text-center py-8 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">No delivery address selected</p>
                  <button
            ...
            {/* Cart Items Review */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700 fade-in-up">
              <h2 className="text-2xl font-bold text-primary-green dark:text-green-400 mb-6">Review Your Order</h2>
              <div className="space-y-4">
                {cartItems.map((item) => (
                  <div key={item.id} className="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-primary-green dark:text-green-400">{item.product.name}</h3>
                      <p className="text-gray-600 dark:text-gray-400">Quantity: {item.quantity}</p>
                    </div>
                    <div className="text-right">
                      <p className="font-bold text-primary-green dark:text-green-400">₱{item.product.price * item.quantity}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* Payment Method */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700 fade-in-up">
              <h2 className="text-2xl font-bold text-primary-green dark:text-green-400 mb-6">Payment Method</h2>
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="cod" className="ml-3 text-gray-700 dark:text-gray-300 font-medium">
                    Cash on Delivery
                  </label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    className="w-4 h-4 text-primary-green focus:ring-primary-green"
                  />
                  <label htmlFor="gcash" className="ml-3 text-gray-700 dark:text-gray-300 font-medium">
                    GCash
                  </label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    className="w-4 h-4 text-primary-green focus:ring-primary-green"
                  />
                  <label htmlFor="card" className="ml-3 text-gray-700 dark:text-gray-300 font-medium">
                    Credit/Debit Card
                  </label>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 h-fit border border-gray-100 dark:border-gray-700 fade-in-up">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold dark:text-white">{shipping === 0 ? 'Free' : `₱${shipping}`}</span>
              </div>
              <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="btn-hover w-full bg-primary-green dark:bg-green-600 text-white px-6 py-4 rounded-xl font-semibold text-center hover:bg-leaf-green dark:hover:bg-green-500 transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed mb-4"
            >
            ...
            <Link
              href="/cart"
              className="w-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-6 py-4 rounded-xl font-medium text-center hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-300 block"
            >
              Back to Cart
            </Link>
            ...
            <div className="mt-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-xl border border-green-200 dark:border-green-800">
              ...
              <p className="text-sm text-green-600 dark:text-green-500">Your payment information is protected</p>
            </div>
          </div>
        </div>
      </div>
