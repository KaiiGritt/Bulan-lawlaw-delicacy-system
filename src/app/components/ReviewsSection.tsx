        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {session && !showReviewForm && (
            <button
              ...
              className="bg-gradient-to-r from-primary-green to-banana-leaf hover:from-leaf-green hover:to-soft-green text-white px-6 py-2 rounded-lg font-medium shadow-md hover:shadow-lg transition-all transform hover:scale-[1.02] flex items-center gap-2"
            >
