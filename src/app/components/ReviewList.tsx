            ...
            >
              <div className="flex gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {review.sellerReply && (
                    <div className="mt-3 sm:mt-4 bg-primary-green/5 dark:bg-green-900/20 border-l-4 border-primary-green dark:border-green-600 rounded-r-lg p-3 sm:p-4">
                      <div className="flex items-start justify-between gap-2 mb-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs sm:text-sm font-semibold text-primary-green dark:text-green-400">
                            Seller Response
                          </span>
                        </div>
                      ...
                      {replyingTo === review.id ? (
                        <div className="space-y-2">
                          <textarea
                            ...
                            className="w-full p-2.5 sm:p-3 text-xs sm:text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-green focus:border-transparent"
                            rows={3}
                          />
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg text-xs sm:text-sm font-medium hover:bg-gray-300 dark:hover:bg-gray-500 transition-colors"
                            >
                              Cancel
                            </button>
                          </div>
                        ...
                        <button
                          ...
                          className="text-xs sm:text-sm text-primary-green dark:text-green-400 hover:text-leaf-green dark:hover:text-green-300 font-medium flex items-center gap-1"
                        >
                          <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6" />
                          </svg>
