        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4 pointer-events-none">
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full overflow-hidden pointer-events-auto"
            >
              {/* Header */}
              ...
              <div className="p-6">
                {/* Product Info */}
                <div className="flex gap-4 bg-gray-50 dark:bg-gray-700 rounded-xl p-4 mb-6">
                  <img
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3.5 rounded-xl border-2 border-gray-300 dark:border-gray-600 hover:border-primary-green dark:hover:border-primary-green text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition-all"
                  >
                    Continue Shopping
                  </button>
                </div>
