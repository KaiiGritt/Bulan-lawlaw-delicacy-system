...
export default function ReviewForm({ itemId, itemType, existingReview, onSubmitSuccess }: ReviewFormProps) {
 ...
 <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">Please login to leave a review</p>
 <button
 ...
 className="w-full p-2.5 sm:p-3 rounded-lg border border-gray-300 bg-white text-sm sm:text-base text-gray-900 focus:ring-2 focus:ring-primary-green focus:border-transparent"
 required
 />
