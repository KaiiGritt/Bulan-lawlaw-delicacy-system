...
export default function NotificationsPage() {
 ...
 return (
 <div className="min-h-screen bg-gradient-to-br from-cream-50 to-green-50 py-6 sm:py-12 px-3 sm:px-4 lg:px-8">
 <div className="max-w-4xl mx-auto">
 {/* Header Skeleton */}
 <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 sm:mb-8 gap-3 sm:gap-0 animate-pulse">
 <div>
 <div className="h-8 sm:h-10 bg-gray-200 rounded w-48 mb-2"></div>
 ...
 {[1, 2, 3, 4, 5].map((i) => (
 <div key={i} className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 animate-pulse">
 ...
 <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 bg-gray-200 rounded-full flex-shrink-0"></div>
 </div>
