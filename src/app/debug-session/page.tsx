  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">Session Debug Info</h1>

        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 mb-4 shadow">
          <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Session Status</h2>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 mb-4 shadow">
          <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">LocalStorage</h2>
          <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded overflow-auto">
