...
export default function ProductsPage() {
 ...
 <p className="text-sm sm:text-base text-gray-500 mb-4 sm:mb-6">Try selecting a different category</p>
 <button
 onClick={() => setSelectedCategory('All')}
 className="bg-primary-green text-white px-6 py-3 rounded-xl font-medium hover:bg-leaf-green transition-colors duration-300 text-sm sm:text-base"
 >
 View All Products
 </button>
 </div>
 ...
 <div className="bg-primary-green rounded-xl sm:rounded-2xl p-6 sm:p-8 text-white">
 ...
 <Link
 href="/contact"
 className="inline-block bg-white text-primary-green px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base lg:text-lg hover:bg-accent-cream transition-colors duration-300"
 >
 Get in Touch
 </Link>
 </div>
