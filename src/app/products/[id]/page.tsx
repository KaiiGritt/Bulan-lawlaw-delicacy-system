...
export default function ProductPage({ params }: ProductPageProps) {
 ...
 return (
 <div className="min-h-screen bg-gradient-to-br from-cream-50 to-green-50 py-4 sm:py-8 lg:py-12">
 ...
 <span className="text-sm sm:text-base font-medium text-gray-900 underline decoration-dotted">
 ...
 <div className="bg-soft-green/10 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
 ...
 className="w-20 sm:w-24 px-3 py-2 border border-gray-300 bg-white text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-green text-sm sm:text-base"
 />
 </div>
 ...
 <h2 className="text-base sm:text-lg font-semibold mb-3 text-gray-900">Product Details</h2>
 <div className="bg-soft-green/5 rounded-lg border border-soft-green/20 overflow-hidden">
 <div className="divide-y divide-soft-green/20">
 <div className="flex py-2.5 sm:py-3 px-3 sm:px-4">
 <span className="text-xs sm:text-sm text-gray-500 w-24 sm:w-32 flex-shrink-0">Category</span>
 <span className="text-xs sm:text-sm text-gray-900 font-medium">
 {product.category.charAt(0).toUpperCase() + product.category.slice(1)}
 </span>
 </div>
 <div className="flex py-2.5 sm:py-3 px-3 sm:px-4">
 <span className="text-xs sm:text-sm text-gray-500 w-24 sm:w-32 flex-shrink-0">Stock</span>
 <span className="text-xs sm:text-sm text-gray-900 font-medium">
 {product.stock} pieces available
 </span>
 </div>
 <div className="flex py-2.5 sm:py-3 px-3 sm:px-4">
 <span className="text-xs sm:text-sm text-gray-500 w-24 sm:w-32 flex-shrink-0">Origin</span>
 <span className="text-xs sm:text-sm text-gray-900 font-medium">
 ...
 <h2 className="text-base sm:text-lg font-semibold mb-3 text-gray-900">Description</h2>
 ...
 className="block mt-4 sm:mt-6 lg:mt-8 bg-gradient-to-r from-white to-soft-green/5 rounded-xl sm:rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 border border-soft-green/30 overflow-hidden"
 >
 ...
 <span className="hidden sm:inline-flex px-2 py-0.5 bg-primary-green/10 text-primary-green rounded text-[10px] font-medium flex-shrink-0">
 Official
 </span>
 </div>
 ...
 <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-gray-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
 </svg>
 <span className="text-[10px] sm:text-xs text-gray-600 line-clamp-1">
 ...
 <div className="flex-shrink-0 bg-soft-green/10 rounded-lg p-2 sm:p-2.5 hover:bg-primary-green/20 transition-colors">
 ...
 <div className="flex gap-2 mt-3 pt-3 border-t border-soft-green/20">
 <button
 onClick={(e) => {
 e.preventDefault();
 handleContactSeller();
 }}
 className="flex-1 bg-white text-primary-green border border-primary-green/30 px-3 py-2 rounded-lg text-xs sm:text-sm font-medium hover:bg-primary-green/5 transition-colors flex items-center justify-center gap-1.5"
 >
 ...
 : 'bg-primary-green/10 text-primary-green border border-primary-green/30 hover:bg-primary-green/20'
 }`}
 >
 {isFollowing ? (
 <>
 ...
 <div className="mt-6 sm:mt-8 lg:mt-12 bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 border border-gray-100">
 <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-primary-green mb-4 sm:mb-6">You Might Also Like</h2>
