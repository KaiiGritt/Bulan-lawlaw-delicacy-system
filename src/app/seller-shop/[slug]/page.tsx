...
export default function ShopPage({ params }: ShopPageProps) {
 ...
 <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg mb-8 animate-pulse">
 ...
 className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8"
 >
 ...
 className="flex-1 sm:flex-initial bg-white text-primary-green border-2 border-primary-green px-4 sm:px-6 py-2 rounded-lg text-sm font-medium hover:bg-primary-green/5 transition-colors flex items-center justify-center gap-2"
 >
 ...
 <div className="bg-soft-green/10 rounded-lg p-2 sm:p-3 text-center">
 <div className="text-lg sm:text-xl lg:text-2xl font-bold text-primary-green">
 ...
 <div className="text-[10px] sm:text-xs text-gray-600">Joined</div>
 </div>
 </div>
 ...
 className="w-full sm:w-auto px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-100 text-gray-700 rounded-lg text-xs sm:text-sm border-none focus:ring-2 focus:ring-primary-green"
 >
 ...
 className="block bg-white rounded-lg sm:rounded-xl hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-gray-100 group"
 >
 {/* Product Image */}
 ...
 <h3 className="text-xs sm:text-sm font-medium text-gray-900 line-clamp-2 min-h-[32px] sm:min-h-[40px] mb-1 sm:mb-2">
 {product.name}
 </h3>
