...
export default function LoginPage() {
 ...
 setTimeoutMessage('Your session expired due to inactivity. Please login again.');
 // Clear the timeout param after 5 seconds
 ...
 exit={{ opacity: 0, y: -10 }}
 className="bg-yellow-50 border border-yellow-200 text-yellow-800 px-4 py-3 rounded-xl text-sm flex items-start gap-2"
 >
