...
export default function RecipePage({ params }: RecipePageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-accent-cream to-soft-green/20 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-12">
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6">
            <Link
              href="/recipes"
              className="btn-hover inline-flex items-center text-primary-green dark:text-green-400 hover:text-leaf-green transition-colors duration-200"
            >
          ...
          {/* Recipe Header */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-soft-green/20 dark:border-gray-700 p-8 mb-8 fade-in-up">
            <div className="flex flex-col lg:flex-row lg:items-start lg:space-x-8">
              {/* Recipe Image */}
              <div className="lg:w-1/2 mb-6 lg:mb-0">
                <div className="relative h-80 lg:h-96 rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-700 flex items-center justify-center">
                  <Image
                  ...
                  <div className="absolute top-4 left-4">
                    <span className={`inline-block px-3 py-1 text-xs font-semibold rounded-full ${
                      recipe.difficulty === 'Beginner' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' :
                      recipe.difficulty === 'Intermediate' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200' :
              ...
              <div className="lg:w-1/2">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">{recipe.description}</p>

                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl">
                    <div className="text-2xl font-bold text-primary-green dark:text-green-400">{recipe.prepTime}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">Prep Time</div>
                  </div>
                  <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl">
                    <div className="text-2xl font-bold text-primary-green dark:text-green-400">{recipe.cookTime}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">Cook Time</div>
                  </div>
                  <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl">
                    <div className="text-2xl font-bold text-primary-green dark:text-green-400">{recipe.servings}</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-soft-green/20 dark:border-gray-700 p-6 fade-in-up" style={{ animationDelay: '0.1s' }}>
                <h2 className="text-2xl font-bold text-primary-green dark:text-green-400 mb-6 flex items-center gap-2">
                ...
                <ul className="space-y-3">
                  {recipe.ingredients.map((ingredient, index) => (
                    <li key={index} className="flex items-start">
                      <span className="w-2 h-2 bg-primary-green dark:bg-green-400 rounded-full mr-4 mt-2 flex-shrink-0"></span>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-soft-green/20 dark:border-gray-700 p-6 fade-in-up" style={{ animationDelay: '0.2s' }}>
                <h2 className="text-2xl font-bold text-primary-green dark:text-green-400 mb-6 flex items-center gap-2">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <ol className="space-y-6">
                  {recipe.instructions.map((instruction, index) => (
                    <li key={index} className="flex">
                      ...
                      <p className="text-gray-700 dark:text-gray-300 leading-relaxed pt-1">{instruction}</p>
                    </li>
                  ))}
                </ol>
              </div>
