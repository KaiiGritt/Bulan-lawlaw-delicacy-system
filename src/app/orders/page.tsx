...
export default function OrdersPage() {
 ...
 <div className="h-10 bg-gray-200 rounded-lg w-32 ml-auto"></div>
 </div>
 </div>
 </div>
 <div className="p-6">
 ...
 <div className="max-w-6xl mx-auto">
 <div className="mb-8">
 <h1 className="text-3xl font-bold text-primary-green">My Orders</h1>
 <p className="mt-1 text-gray-600">Track and manage your order history</p>
 </div>
